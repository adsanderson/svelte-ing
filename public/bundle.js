...
var template = (function () {
    ...
    function topPosition(imageHeight) {
        const init = (containerHeight - imageHeight) / 2;
        const position = Math.max(0, init);
        return `${position}px` 
    }
...
function add_css () {
	...
	style.id = "svelte-131483519-style";
	style.textContent = "\n  [svelte-131483519].insta, [svelte-131483519] .insta {\n      height: 640px;\n      width: 640px;\n      overflow: hidden;\n      position: relative;\n  }\n  [svelte-131483519].insta__image, [svelte-131483519] .insta__image {\n      position: absolute;\n      top: 0;\n      left: 0;\n      opacity: 0;\n      transition: opacity 1s;\n  }\n  [svelte-131483519].insta__image--active, [svelte-131483519] .insta__image--active {\n      opacity: 1;\n  }\n";
	appendNode( style, document.head );
}

function create_main_fragment ( state, component ) {
	var div = createElement( 'div' );
	setAttribute( div, 'svelte-131483519', '' );
	div.className = "insta";
...
function create_each_block ( state, each_block_value, imgSrc, imgSrc_index, component ) {
	...
	return {
		...
		update: function ( changed, state, each_block_value, imgSrc, imgSrc_index ) {
...
function Hw ( options ) {
	...
	if ( !document.getElementById( "svelte-131483519-style" ) ) add_css();
